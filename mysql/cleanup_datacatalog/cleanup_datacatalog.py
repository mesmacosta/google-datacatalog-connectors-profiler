...
def __delete_tag_templates(project_id, location_id, rdbms_type,
...
def __parse_args():
    parser = argparse.ArgumentParser(
        description=
        'Command line to clean up all Teradata metadata on Datacatalog')
...
if __name__ == "__main__":
    ...
    for datacatalog_project_id in datacatalog_project_ids:
        __delete_tag_templates(datacatalog_project_id,
                               args.datacatalog_location_id, args.rdbms_type,
